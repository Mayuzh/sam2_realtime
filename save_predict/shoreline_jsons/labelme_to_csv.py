...
def main():
    ...
    ap.add_argument("--input", default="./trevone/", help="Path to a LabelMe JSON file OR a ROOT folder to scan recursively for folders that directly contain JSONs.")
    ap.add_argument("--output", default="./csv/trevone/", help="Output ROOT folder (for directory input) or output CSV file (for single-file input). When input is a directory, the directory tree is mirrored under this root.")
