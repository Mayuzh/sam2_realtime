...
def main():
    ...
    ap.add_argument("--input", default="./twinlakes/onshore_high", help="Path to a LabelMe JSON file OR a ROOT folder to scan recursively for folders that directly contain JSONs.")
    ap.add_argument("--output", default="./csv/twinlakes/onshore_high", help="Output ROOT folder (for directory input) or output CSV file (for single-file input). When input is a directory, the directory tree is mirrored under this root.")
