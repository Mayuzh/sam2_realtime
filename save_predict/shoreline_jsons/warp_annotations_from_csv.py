...
def main():
    ...
    ap.add_argument("--points", default="./csv/twinlakes/8/", help="Input points CSV or a folder of CSVs (each must contain columns x,y).")
    ap.add_argument("--links", default="./links/control_points2.txt", help="Control points file: ArcGIS link table (.txt) or generic CSV.")
    ap.add_argument("--out", default="./csv/twinlakes_rec/8/", help="Output warped CSV file, or an output folder when --points is a folder.")
