...
def main():
    ...
    parser.add_argument('--dir', '-d', default='./jennette_pier/', help='Directory to scan (default: current)')
    parser.add_argument('--min-points', '-m', type=int, default=200, help='Minimum number of points required (default: 200)')
