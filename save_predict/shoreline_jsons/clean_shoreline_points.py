...
def main():
    ...
    parser.add_argument('--json-dir', '-d', default='./seabright_new/', help='Directory of shoreline JSON files (default: ./twinlakes)')
    parser.add_argument('--mask-json', '-m', default='./mask/walton_lighthouse-2024-01-11-212748Z_000007.json', help='Path to rock mask JSON (default: ./masks/rock_mask.json)')
