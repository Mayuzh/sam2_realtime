...
def main():
    ...
    parser.add_argument('--json-dir', '-d', default='./shoreline_outputs/seabright/south_westerly_onshore', help='Directory of shoreline JSON files (default: ./twinlakes)')
    parser.add_argument('--mask-json', '-m', default='./mask/rock_mask.json', help='Path to rock mask JSON (default: ./masks/rock_mask.json)')
